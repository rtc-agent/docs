...
![RTC Agent 界面总览](/docs/demo-screenshot/chat-demo.png)
...
双层记忆：**Session Memory**（会话上下文压缩）+ **User Memory**（跨会话长期记忆，支持关键词检索）。AI 真正"记住"你的用户。
...
- [快速开始](/docs/getting-started/) — 5 分钟接入 RTC Agent
- [核心概念](/docs/concepts/) — 深入理解 RTC 协议和虚拟文件系统
- [集成指南](/docs/integration/) — 学习如何注册 Function 和编写 Scenario
