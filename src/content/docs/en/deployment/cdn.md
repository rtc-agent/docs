...
> 💡 Replace `your-rtc-server.com` with your actual RTC Agent Server address. To use the latest version, replace `@0.1.0` with the latest version number or remove the version to use the latest.
...
```bash
curl -I https://cdn.jsdelivr.net/npm/@rtc-agent/component@0.1.0/dist/assets/shared-worker-xxx.js
