...
**`<rtc-agent>`** is the **sole component** exposed by RTC Agent. Built on Lit, it contains 48 sub-components and 20 Controllers internally, but presents only a clean Web Component interface externally — attribute configuration, event listening, and CSS variable customization.
