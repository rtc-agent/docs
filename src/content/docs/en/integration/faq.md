...
```
GET https://esm.sh/@rtc-agent/component@0.2.6-rc.1/es2022/assets/shared-worker-xxx.js 404 (Not Found)
...
```html
<!-- Wrong ❌ -->
<script src="https://esm.sh/@rtc-agent/component@0.2.6-rc.1"></script>

<!-- Correct ✅ -->
<script src="https://cdn.jsdelivr.net/npm/@rtc-agent/component@0.2.6-rc.1/dist/index.js"></script>
```
