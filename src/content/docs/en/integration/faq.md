...
```
GET https://esm.sh/@rtc-agent/component@0.2.3/es2022/assets/shared-worker-xxx.js 404 (Not Found)
...
```html
<!-- Wrong ❌ -->
<script src="https://esm.sh/@rtc-agent/component@0.2.3"></script>

<!-- Correct ✅ -->
<script src="https://cdn.jsdelivr.net/npm/@rtc-agent/component@0.2.3/dist/index.js"></script>
```
